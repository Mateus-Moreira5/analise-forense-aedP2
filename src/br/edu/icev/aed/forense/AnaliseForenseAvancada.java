...
public interface AnaliseForenseAvancada {
     ...
     */
    Set<String> desafio1_encontrarSessoesInvalidas(String caminhoArquivo) throws IOException;
     ...
     * @throws IOException Se houver erro ao ler o arquivo
     */
    List<String> desafio2_reconstruirLinhaTempo(String caminhoArquivo, String sessionId) throws IOException;
     ...
     * @throws IOException Se houver erro ao ler o arquivo
     */
    List<Alerta> desafio3_priorizarAlertas(String caminhoArquivo, int n) throws IOException;
     ...
     * @throws IOException Se houver erro ao ler o arquivo
     */
    Map<Long, Long> desafio4_encontrarPicosTransferencia(String caminhoArquivo) throws IOException;
     ...
     * @throws IOException Se houver erro ao ler o arquivo
     */
    Optional<List<String>> desafio5_rastrearContaminacao(String caminhoArquivo, String recursoInicial, String recursoAlvo) throws IOException;
}
